...
// import type {SongData2, SongDataColumn2, SongDataInstrument2} from "./soundbox2";
//
...
//     const S:SongData2 = [song.songData_.map(
//         (i): SongDataInstrument2 => [
//             i.i, i.p, i.c.map(
//                 (c): SongDataColumn2 => [c.n, c.f])]
//     ), song.rowLen_, song.patternLen_, song.endPattern_, song.numChannels_];
