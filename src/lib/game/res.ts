...
function createAudio() {
    snd_med = snd_heal = snd_pick = snd_blip = createAudioBuffer([0,0,6746,0,12788,1228.2389422369547,0,0.9999881645047234,0,0,0,1,20032,0.21049001812934875,0,0,0,0,0.1,1,0.55,0,1]);
    snd_shoot = createAudioBuffer([0,0,6634,0,5287,139.448,24079,1.00229,0,0,0,1,20032,0.112038,0.00000513617,0,0,0,0.1,1,0.55,0.0000833995,1]);
